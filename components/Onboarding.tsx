...
/**
 * Las diez que terminan la prueba. Van acá además de en la guía: en la guía
 * quedan detrás de una sección plegada de un archivo de 32.000 caracteres, y
 * esto es justo lo que nadie se puede enterar tarde.
 */
const FALTAS_GRAVES = [
  'Faltar sin avisar o abandonar el turno antes de terminar.',
  'Salir a fumar sin avisar a tu referente o al encargado.',
  'Usar el celular en el salón sin autorización.',
  'Faltarle el respeto a un compañero, superior o proveedor.',
  'Maltratar o faltarle el respeto a un cliente.',
  'Cualquier forma de discriminación o acoso, dentro o fuera del turno, hacia clientes o compañeros.',
  'Llegar bajo los efectos del alcohol o drogas, o consumirlos durante el turno.',
  'Tomar dinero, productos o pertenencias de clientes, compañeros o del lugar.',
  'Quedarse con propinas que corresponden al pozo común.',
  'Consumir comida o bebida del restaurante sin autorización.',
]
            ...
            {isNuevo && (
              <div className="bg-brand-card border border-brand-border rounded-2xl overflow-hidden">
                <div className="bg-brand-error/10 border-b border-brand-error/20 px-5 py-2.5">
                  <p className="text-brand-error text-[11px] font-bold uppercase tracking-widest text-center">
                    Esto termina la prueba
                  </p>
                </div>
                <div className="p-5 space-y-3">
                  <p className="text-sm text-brand-text leading-relaxed">
                    Valoramos el aprendizaje y entendemos que al principio se cometen errores.
                    Pero hay conductas que <strong>no tienen margen</strong>: cualquiera de estas
                  ...
                  <p className="text-xs text-brand-muted leading-relaxed border-t border-brand-border pt-3">
                    No es una amenaza: es para que nadie se entere tarde. Todo lo demás se corrige
                    hablando.
                  </p>
                </div>
              </div>
