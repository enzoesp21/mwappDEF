...
-- NOTA: se corrió sin el freno de seguridad, por decisión explícita.
-- El intento pendiente de Leonel Schroeder pierde 15 respuestas de opción
-- múltiple (14 de ellas correctas). Su nota se recalculará sobre las que
-- queden cuando se corrijan sus 5 respuestas escritas: pasa de ~87% a ~83%,
-- así que aprueba igual.
